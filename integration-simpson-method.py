...
# Simpson
#
# Implementation of Simpson's method to integrate functions.
#
#
###############################################################################
###############################################################################
...
# The number of subdivisions. Always choose an even number!
Num_parts = 8
...
def func_x(r): return 1/(1+r*r)
#def func_x(r): return 1/r
#def func_x(r): return math.exp(-r*r)
#def func_x(r): return math.log(r)
...
A = (h/3)*(y[0]+y[Num_parts])

# Odd Part
for j in range(0,int(Num_parts/2)):
    A = A+(h/3)*4*y[2*j+1]

# Even Part
for j in range(1,int(Num_parts/2)):
    A = A+(h/3)*2*y[2*j]
